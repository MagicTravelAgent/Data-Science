...
txt_cities = open(r"C:\Users\stanc\Desktop\DSP\cities.txt", encoding="utf8")
...
while k<200:
    try: 
        #open adverts
        txt_file = open(r"C:\Users\stanc\Desktop\DSP\OCRed images\entry_{}.txt".format(k), encoding="utf8")
...
update.to_excel(r"C:\Users\stanc\Desktop\DSP\extra_info_update.xlsx", index= False)
